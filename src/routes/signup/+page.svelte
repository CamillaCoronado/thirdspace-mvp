...
<div class="flex flex-col mx-16 wide-letter">
  <div>
    ...
    <Button text="Facebook" bgColor="bg-fb-blue" on:click={() => handleSocialLogin('Facebook')}></Button>
    <Button text="Google" bgColor="bg-g-blue" on:click={() => handleSocialLogin('Google')}></Button>
